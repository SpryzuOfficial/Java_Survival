...
import Game.entities.StoneTilesE;
import Game.entities.StaticEntity;
import Game.tiles.Tile;
import Game.tiles.TileManager;

public class StoneTiles extends Item
{
	public StoneTiles(int count, int x, int y) 
	{
		super(Assets.stoneTiles, count, x, y, 1, 1, 1, true, -1, 0);
	}
	...
	public boolean place()
	{
		...
		StaticEntity entity = new StoneTilesE(tile.getVx(), tile.getVy(), tile.getGx(), tile.getGy());
